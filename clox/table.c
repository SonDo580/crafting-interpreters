                        ...
                        ObjString *key)
{
    ...
    uint32_t index = key->hash & (capacity - 1); // a % 2^k = a & (2^k - 1)
    ...
    for (;;)
    {
        ...
        index = (index + 1) & (capacity - 1); // a % 2^k = a & (2^k - 1)
    }
                           ...
                           int length, uint32_t hash)
{
    ...
    uint32_t index = hash & (table->capacity - 1); // a % 2^k = a & (2^k - 1)
    for (;;)
    {
        ...
        index = (index + 1) & (table->capacity - 1); // a % 2^k = a & (2^k - 1)
    }
}
